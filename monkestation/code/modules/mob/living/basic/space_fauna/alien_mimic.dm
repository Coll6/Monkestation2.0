/mob/living/basic/alien_mimic
	name = "mimic"
	real_name = "mimic"
	desc = "A morphing mass of black gooey tendrils."
	speak_emote = list("warbles")
	faction = list("aliens", FACTION_HOSTILE) //don't wanna have them attack eachother
	icon = 'monkestation/icons/mob/basic/alien_mimic.dmi'
	icon_state = "mimic"
	icon_living = "mimic"
