...
/datum/language_holder/alien_mimic
	understood_languages = list(/datum/language/typhcommon = list(LANGUAGE_ATOM))
	spoken_languages = list(/datum/language/typhcommon = list(LANGUAGE_ATOM))
